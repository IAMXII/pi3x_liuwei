...
#                 # ====== [新增: 打印详细的堆栈跟踪] ======
#                 if _ == 0:  # 只在第一次失败时打印，防止控制台刷屏
#                     dataset_name = getattr(self, 'dataset_label', 'UnknownDataset')
#                     print(f"\n[Error Debug] ⚠️ 捕获到异常! 数据源: {dataset_name}, idx: {idx}")
#                     print(f"[Error Debug] 正在拉取详细的报错追踪:")
#                     traceback.print_exc()
#                     print("-" * 60)
#                 # ========================================
