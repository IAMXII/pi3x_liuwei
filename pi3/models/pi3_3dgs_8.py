...
class Pi3_3DGS(nn.Module):
    ...
    def _apply_local_competition(self, gaussian_dict, source_view, scene_size, camera_poses=None, intrinsics=None, image_hw=None):
        ...
        # Optional physical hard cap: this is not the redundancy mechanism. It is
        # only a safety cap for unusually large forward outputs.
        hard_cap_pruned = 0
    ...
    def _estimate_color_aware_redundancy(self, gaussian_dict, voxel_size, local_radius=None):
        ...
        and color-similar Gaussians are counted as redundant competitors.
        """
        xyz = gaussian_dict["xyz"]
        K = xyz.shape[0]
        device = xyz.device
        ...
        if 0 < K <= self.redundancy_exact_max_points:
            ...
            return torch.cat(redundancy_parts, dim=0)
