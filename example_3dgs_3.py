...
def main():
    ...
    parser.add_argument("--gs_view_stride", type=int, default=2,
                        help="View stride used by the model Gaussian branch. 2 uses about half of the input views.")
    ...
    print(f"Using Pi3_3DGS implementation: pi3.models.pi3_3dgs_7")
    ...
    with open(metrics_file, "w") as f:
        ...
        f.write("model_impl: pi3.models.pi3_3dgs_7\n")
